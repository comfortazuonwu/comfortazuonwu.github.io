const apiURL2 =
  "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=947ca8f837f28d9961098ed394e67efc";
fetch(apiURL2)
  ...
  const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=947ca8f837f28d9961098ed394e67efc&units=imperial"
...
fetch(apiURL)
  ...
  const soda = 'https://byui-cit230.github.io/weather/data/towndata.json';
